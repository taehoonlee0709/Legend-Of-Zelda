...
void CDoorBlock::Initialize()
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Terrain/DoorBlock.bmp", L"DoorBlock");
	m_pFrameKey = L"DoorBlock";
	m_tInfo.fCX = BLOCK_DOOR_CX;
	m_tInfo.fCY = BLOCK_DOOR_CY;
	//m_fSpeed = 4.f;
...
void CDoorBlock::Render(HDC hDC)
{
...
void CDoorBlock::Release()
{
}

void CDoorBlock::CollisionPlayer()
{
